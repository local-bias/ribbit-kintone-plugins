...
export const ui = {
  ja: {
    ...
    'config.app.form.bulkUpdate.title': '一括更新機能の設定',
    'config.app.form.isBulkUpdateEnabled.description':
      'フィルターされたレコードに対して、特定のフィールドを一括で更新できるようになります。更新できるのは、レコードに対して編集権限を持つユーザーのみです。',
    'config.app.form.isBulkUpdateEnabled.label': '一括更新機能を有効にする',
    'config.app.form.isBulkUpdaterControlEnabled.title': '一括更新機能の制限',
    'config.app.form.isBulkUpdaterControlEnabled.description':
      'アプリ標準の権限設定に加えて、プラグイン独自の一括更新権限を設定することができます。この設定を有効にすると、指定したユーザー以外はプラグインの一括更新機能を利用できなくなります。',
    'config.app.form.isBulkUpdaterControlEnabled.label': '一括更新できるユーザーを制限する',
    'config.app.form.bulkUpdaters.title': '一括更新可能なユーザー',
    'config.app.form.bulkUpdaters.description':
      '一括更新できるユーザーを設定します。指定されたユーザー・グループ・組織のみがプラグインの一括更新機能を利用できます。',
    ...
    'config.app.form.extractedInputs.type.multiSelect': '複数選択',
    ...
    'desktop.bulkUpdate.title': 'レコードの一括更新',
    'desktop.bulkUpdate.targetRecordsCount': '対象レコード数: {0}件',
    'desktop.bulkUpdate.field': '更新するフィールド',
    'desktop.bulkUpdate.value': '更新する値',
    'desktop.bulkUpdate.valueHint': 'すべての対象レコードがこの値に更新されます',
    'desktop.bulkUpdate.clearValue': '値をクリア',
    'desktop.bulkUpdate.cancel': 'キャンセル',
    'desktop.bulkUpdate.update': '更新',
    'desktop.bulkUpdate.button': '一括更新',
    'desktop.bulkUpdate.success': '{0}件のレコードを更新しました',
    'desktop.bulkUpdate.error': 'レコードの更新に失敗しました',
  ...
  en: {
    ...
    'config.app.form.bulkUpdate.title': 'Bulk update feature settings',
    'config.app.form.isBulkUpdateEnabled.description':
      'You can bulk update filtered records. Only users with edit permissions for the records can update them.',
    'config.app.form.isBulkUpdateEnabled.label': 'Enable bulk update feature',
    'config.app.form.isBulkUpdaterControlEnabled.title': 'Bulk update feature restrictions',
    'config.app.form.isBulkUpdaterControlEnabled.description':
      "In addition to the standard app permissions, you can set unique bulk update permissions for the plugin. If this setting is enabled, only specified users can use the plugin's bulk update function.",
    'config.app.form.isBulkUpdaterControlEnabled.label': 'Restrict users who can bulk update',
    'config.app.form.bulkUpdaters.title': 'Users who can bulk update',
    'config.app.form.bulkUpdaters.description':
      "Set the users who can bulk update. Only the specified users, groups, and organizations can use the plugin's bulk update function.",
    ...
    'config.app.form.extractedInputs.type.multiSelect': 'Multi-select',
    ...
    'desktop.bulkUpdate.title': 'Bulk Update Records',
    'desktop.bulkUpdate.targetRecordsCount': 'Target Records: {0}',
    'desktop.bulkUpdate.field': 'Field to Update',
    'desktop.bulkUpdate.value': 'Value',
    'desktop.bulkUpdate.valueHint': 'All target records will be updated to this value',
    'desktop.bulkUpdate.clearValue': 'Clear value',
    'desktop.bulkUpdate.cancel': 'Cancel',
    'desktop.bulkUpdate.update': 'Update',
    'desktop.bulkUpdate.button': 'Bulk Update',
    'desktop.bulkUpdate.success': 'Updated {0} record(s)',
    'desktop.bulkUpdate.error': 'Failed to update records',
  ...
  es: {
    ...
    'config.app.form.extractedInputs.type.multiSelect': 'Selección múltiple',
    ...
    'desktop.bulkUpdate.title': 'Actualización masiva de registros',
    'desktop.bulkUpdate.targetRecordsCount': 'Registros objetivo: {0}',
    'desktop.bulkUpdate.field': 'Campo a actualizar',
    'desktop.bulkUpdate.value': 'Valor',
    'desktop.bulkUpdate.valueHint': 'Todos los registros objetivo se actualizarán a este valor',
    'desktop.bulkUpdate.clearValue': 'Borrar valor',
    'desktop.bulkUpdate.cancel': 'Cancelar',
    'desktop.bulkUpdate.update': 'Actualizar',
    'desktop.bulkUpdate.button': 'Actualización masiva',
    'desktop.bulkUpdate.success': 'Se actualizaron {0} registro(s)',
    'desktop.bulkUpdate.error': 'Error al actualizar los registros',
  ...
  zh: {
    ...
    'desktop.bulkUpdate.title': '批量更新记录',
    'desktop.bulkUpdate.targetRecordsCount': '目标记录数: {0}',
    'desktop.bulkUpdate.field': '要更新的字段',
    'desktop.bulkUpdate.value': '值',
    'desktop.bulkUpdate.valueHint': '所有目标记录将被更新为此值',
    'desktop.bulkUpdate.clearValue': '清除值',
    'desktop.bulkUpdate.cancel': '取消',
    'desktop.bulkUpdate.update': '更新',
    'desktop.bulkUpdate.button': '批量更新',
    'desktop.bulkUpdate.success': '已更新{0}条记录',
    'desktop.bulkUpdate.error': '记录更新失败',
  ...
  'zh-TW': {
    ...
    'desktop.bulkUpdate.title': '批量更新記錄',
    'desktop.bulkUpdate.targetRecordsCount': '目標記錄數: {0}',
    'desktop.bulkUpdate.field': '要更新的字段',
    'desktop.bulkUpdate.value': '值',
    'desktop.bulkUpdate.valueHint': '所有目標記錄將被更新為此值',
    'desktop.bulkUpdate.clearValue': '清除值',
    'desktop.bulkUpdate.cancel': '取消',
    'desktop.bulkUpdate.update': '更新',
    'desktop.bulkUpdate.button': '批量更新',
    'desktop.bulkUpdate.success': '已更新{0}條記錄',
    'desktop.bulkUpdate.error': '記錄更新失敗',
  ...
  'pt-BR': {
    ...
    'desktop.bulkUpdate.title': 'Atualização em massa de registros',
    'desktop.bulkUpdate.targetRecordsCount': 'Registros alvo: {0}',
    'desktop.bulkUpdate.field': 'Campo a atualizar',
    'desktop.bulkUpdate.value': 'Valor',
    'desktop.bulkUpdate.valueHint': 'Todos os registros alvo serão atualizados para este valor',
    'desktop.bulkUpdate.clearValue': 'Limpar valor',
    'desktop.bulkUpdate.cancel': 'Cancelar',
    'desktop.bulkUpdate.update': 'Atualizar',
    'desktop.bulkUpdate.button': 'Atualização em massa',
    'desktop.bulkUpdate.success': '{0} registro(s) atualizado(s)',
    'desktop.bulkUpdate.error': 'Falha ao atualizar registros',
  ...
  th: {
    ...
    'desktop.bulkUpdate.title': 'อัปเดตเรคคอร์ดเป็นกลุ่ม',
    'desktop.bulkUpdate.targetRecordsCount': 'เรคคอร์ดเป้าหมาย: {0}',
    'desktop.bulkUpdate.field': 'ฟิลด์ที่จะอัปเดต',
    'desktop.bulkUpdate.value': 'ค่า',
    'desktop.bulkUpdate.valueHint': 'เรคคอร์ดเป้าหมายทั้งหมดจะถูกอัปเดตเป็นค่านี้',
    'desktop.bulkUpdate.clearValue': 'ล้างค่า',
    'desktop.bulkUpdate.cancel': 'ยกเลิก',
    'desktop.bulkUpdate.update': 'อัปเดต',
    'desktop.bulkUpdate.button': 'อัปเดตเป็นกลุ่ม',
    'desktop.bulkUpdate.success': 'อัปเดต {0} เรคคอร์ดแล้ว',
    'desktop.bulkUpdate.error': 'ไม่สามารถอัปเดตเรคคอร์ดได้',
