...
export const parentFolderIdAtom = getConditionPropertyAtom('parentFolderId');
export const folderIdFieldCodeAtom = getConditionPropertyAtom('folderIdFieldCode');
export const folderNameFieldCodesAtom = getConditionPropertyAtom('folderNameFieldCodes');
export const folderCreationTriggerAtom = getConditionPropertyAtom('folderCreationTrigger');
