...
const ui = mergeDeep(commonUi, {
  ja: {
    ...
    'desktop.bulkUpdate.dialog.actions.run': '実行',
    'desktop.bulkUpdate.dialog.actions.cancel': 'キャンセル',
    'desktop.bulkUpdate.dialog.content.confirm.text1':
      '現在の一覧の検索条件に一致するすべてのレコードを一括で更新します。よろしければ「実行」をクリックしてください。',
    'desktop.bulkUpdate.dialog.content.confirm.length': '更新対象レコード数',
    'desktop.bulkUpdate.dialog.content.confirm.skipped':
      '更新条件を満たさずスキップされるレコード数',
    'desktop.bulkUpdate.dialog.content.confirm.unit': '件',
    'desktop.bulkUpdate.dialog.content.loader.getRecords': '対象レコードを取得しています',
    'desktop.bulkUpdate.dialog.content.loader.updateRecords': 'レコードを更新しています',
    'desktop.bulkUpdate.dialog.content.success.title': '更新が完了しました',
    'desktop.bulkUpdate.dialog.content.success.description': '件のレコードを更新しました',
    'desktop.bulkUpdate.dialog.content.notFound.title': '更新対象が見つかりませんでした',
    'desktop.bulkUpdate.dialog.content.notFound.description':
      '現在の検索条件に一致する更新可能なレコードは存在しません。',
    'desktop.bulkUpdate.dialog.content.error.getRecords': 'レコードの取得に失敗しました',
    'desktop.bulkUpdate.dialog.content.error.updateRecords': 'レコードの更新に失敗しました',
    'desktop.bulkUpdate.dialog.content.error.details': 'エラーの詳細',
  ...
  en: {
    ...
    'desktop.bulkUpdate.dialog.actions.run': 'Execute',
    'desktop.bulkUpdate.dialog.actions.cancel': 'Cancel',
    'desktop.bulkUpdate.dialog.content.confirm.text1':
      'All records matching the current list search criteria will be updated in bulk. Click "Execute" to proceed.',
    'desktop.bulkUpdate.dialog.content.confirm.length': 'Records to update',
    'desktop.bulkUpdate.dialog.content.confirm.skipped':
      'Records to be skipped (validation failed)',
    'desktop.bulkUpdate.dialog.content.confirm.unit': ' records',
    'desktop.bulkUpdate.dialog.content.loader.getRecords': 'Retrieving target records',
    'desktop.bulkUpdate.dialog.content.loader.updateRecords': 'Updating records',
    'desktop.bulkUpdate.dialog.content.success.title': 'Update Complete',
    'desktop.bulkUpdate.dialog.content.success.description': ' records updated',
    'desktop.bulkUpdate.dialog.content.notFound.title': 'No Update Targets Found',
    'desktop.bulkUpdate.dialog.content.notFound.description':
      'No updatable records matching the current criteria were found.',
    'desktop.bulkUpdate.dialog.content.error.getRecords': 'Failed to retrieve records',
    'desktop.bulkUpdate.dialog.content.error.updateRecords': 'Failed to update records',
    'desktop.bulkUpdate.dialog.content.error.details': 'Error details',
  ...
  es: {
    ...
    'desktop.bulkUpdate.dialog.actions.run': 'Ejecutar',
    'desktop.bulkUpdate.dialog.actions.cancel': 'Cancelar',
    'desktop.bulkUpdate.dialog.content.confirm.text1':
      'Se actualizarán en masa todos los registros que coincidan con los criterios de búsqueda actuales. Haga clic en "Ejecutar" para continuar.',
    'desktop.bulkUpdate.dialog.content.confirm.length': 'Registros a actualizar',
    'desktop.bulkUpdate.dialog.content.confirm.skipped': 'Registros omitidos (validación fallida)',
    'desktop.bulkUpdate.dialog.content.confirm.unit': ' registros',
    'desktop.bulkUpdate.dialog.content.loader.getRecords': 'Obteniendo registros objetivo',
    'desktop.bulkUpdate.dialog.content.loader.updateRecords': 'Actualizando registros',
    'desktop.bulkUpdate.dialog.content.success.title': 'Actualización completada',
    'desktop.bulkUpdate.dialog.content.success.description': ' registros actualizados',
    'desktop.bulkUpdate.dialog.content.notFound.title':
      'No se encontraron registros para actualizar',
    'desktop.bulkUpdate.dialog.content.notFound.description':
      'No se encontraron registros actualizables que coincidan con los criterios actuales.',
    'desktop.bulkUpdate.dialog.content.error.getRecords': 'Error al obtener los registros',
    'desktop.bulkUpdate.dialog.content.error.updateRecords': 'Error al actualizar los registros',
    'desktop.bulkUpdate.dialog.content.error.details': 'Detalles del error',
  ...
  zh: {
    ...
    'desktop.bulkUpdate.dialog.actions.run': '执行',
    'desktop.bulkUpdate.dialog.actions.cancel': '取消',
    'desktop.bulkUpdate.dialog.content.confirm.text1':
      '将批量更新符合当前列表搜索条件的所有记录。点击"执行"以继续。',
    'desktop.bulkUpdate.dialog.content.confirm.length': '待更新记录数',
    'desktop.bulkUpdate.dialog.content.confirm.skipped': '跳过的记录数（验证失败）',
    'desktop.bulkUpdate.dialog.content.confirm.unit': '条',
    'desktop.bulkUpdate.dialog.content.loader.getRecords': '正在获取目标记录',
    'desktop.bulkUpdate.dialog.content.loader.updateRecords': '正在更新记录',
    'desktop.bulkUpdate.dialog.content.success.title': '更新完成',
    'desktop.bulkUpdate.dialog.content.success.description': '条记录已更新',
    'desktop.bulkUpdate.dialog.content.notFound.title': '未找到更新目标',
    'desktop.bulkUpdate.dialog.content.notFound.description': '未找到符合当前条件的可更新记录。',
    'desktop.bulkUpdate.dialog.content.error.getRecords': '获取记录失败',
    'desktop.bulkUpdate.dialog.content.error.updateRecords': '更新记录失败',
    'desktop.bulkUpdate.dialog.content.error.details': '错误详情',
