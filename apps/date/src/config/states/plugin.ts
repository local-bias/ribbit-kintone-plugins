...
export const targetFieldCodeAtom = getConditionPropertyAtom('targetFieldCode');
export const basisTypeAtom = getConditionPropertyAtom('basisType');
export const basisFieldCodeAtom = getConditionPropertyAtom('basisFieldCode');
export const adjustmentsAtom = getConditionPropertyAtom('adjustments');
export const isTargetFieldDisabledAtom = getConditionPropertyAtom('isTargetFieldDisabled');
export const isBulkUpdateButtonVisibleAtom = getConditionPropertyAtom('isBulkUpdateButtonVisible');
